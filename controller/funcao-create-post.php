<?php
 ...
 mysqli_query($connect,"INSERT INTO post (cod_empresa,conteudo_post,midia_post, data_post, hora_post) VALUES ('".$_COOKIES['idEmpresa']."','".$_POST["conteudo-postagem"]."','".$nomeCompleto."','".$strD."','".$strH."')");
